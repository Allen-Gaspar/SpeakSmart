...
export default function AboutPage() {
  const features = [
    { icon: Sparkles, title: "AI-Powered Learning", description: "Personalized lessons adapted to your learning pace and style using advanced AI technology." },
    { icon: Mic, title: "Voice Recognition", description: "Real-time pronunciation feedback with native accent training from expert speakers." },
    { icon: Globe, title: "10+ Languages", description: "Learn from English, Spanish, French, German, Mandarin, Japanese, and many more." },
    { icon: Users, title: "Community", description: "Connect with millions of learners worldwide and participate in language challenges." },
  ];
      ...
      <div className="pt-20 pb-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <section>
            ...
            <div className="glass rounded-2xl p-8">
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                SPEAKSMART was founded by a team of linguists, AI researchers, and educators passionate about making language learning accessible to everyone.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
